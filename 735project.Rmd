...
tg <- expand.grid(C = seq(10,90,20)), sigma = c(0.5,1,1.5,2,3,4,5,7,9))
...
cm_rsvm = confusionMatrix(pred_svmRadial, as.factor(test.labels$toxic), positive = "1")
...
cm_lsvm = confusionMatrix(pred_svmLinear, as.factor(test.labels$toxic), positive = "1")
