...
fit <- tune.svm(as.factor(train_mar_y)~., data = train_mar_full, gamma = 2^(-8:8), cost = 0.5)

result2 <- fit

## save output to .RData file
save(result2, file = "/nas/longleaf/home/yutongl/BIOS735/735projhelp/svmsep/s2.RData")
