...
fit <- tune.svm(as.factor(train_mar_y)~., data = train_mar_full, gamma = 2^(-8), cost = 15)

result6 <- fit

## save output to .RData file
save(result6, file = "/nas/longleaf/home/yutongl/BIOS735/735projhelp/svmnew2/s6.RData")
