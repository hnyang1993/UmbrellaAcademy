...
fit <- tune.svm(as.factor(train_mar_y)~., data = train_mar_full, gamma = 2^(-8), cost = 10)

result5 <- fit

## save output to .RData file
save(result5, file = "/nas/longleaf/home/yutongl/BIOS735/735projhelp/svmnew2/s5.RData")
