...
fit <- tune.svm(as.factor(train_mar_y)~., data = train_mar_full, gamma = 2^(-8), cost = 30)

result9 <- fit

## save output to .RData file
save(result9, file = "/nas/longleaf/home/yutongl/BIOS735/735projhelp/svmnew2/s9.RData")
